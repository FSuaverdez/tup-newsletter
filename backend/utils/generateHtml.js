export const generateHtml = (post, category, subCategory) => {
  return `<!DOCTYPE html
                        ...
                        <tr style="vertical-align: top;" valign="top">
                          <td align="center"
                            ...
                            <h1
                              ...
                              <strong><span style="color: #ffffff;">TUP Newsletter</span></strong>
                            </h1>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr style="vertical-align: top;" valign="top">
                          <td align="center"
                            ...
                            <h1
                              style="color:#555555;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:28px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">
                              <strong><span style="color: #ffffff;">New Post</span></strong>
                            </h1>
                          </td>
                        </tr>
                      </table>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div class="txtTinyMce-wrapper"
                          ...
                          <p
                            style="margin: 0; font-size: 20px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                            <span style="font-size: 16px;"><strong>${post.title}</strong></span>
                          </p>
                          <p
                          ...
                          <p
                            style="margin: 0; line-height: 1.2; word-break: break-word; font-size: 15px; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                            <span
                              style="font-size: 15px;">${category?.name}</span>
                          </p>
                          <p
                          style="margin: 0; line-height: 1.2; word-break: break-word; font-size: 15px; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                          <span
                            style="font-size: 15px;">${subCategory?.name}</span>
                        </p>
                          <p
                            style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin-top: 0; margin-bottom: 0;">
                             </p>
...
export const generatePendingHtml = (post, category, subCategory) => {
  return `<!DOCTYPE html
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"
  xmlns:v="urn:schemas-microsoft-com:vml">
                      ...
                      <table cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr style="vertical-align: top;" valign="top">
                          <td align="center"
                            ...
                            <h1
                              style="color:#555555;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:28px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">
                              <strong><span style="color: #ffffff;">New Pending Post</span></strong>
                            </h1>
                          </td>
                        </tr>
                      </table>
                ...
                <div class="col num12"
                  ...
                  <div class="col_cont" style="width:100% !important;">
                    <div
                      ...
                      <div align="center" class="button-container"
                        style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                        <a href="${process.env.URL}/content/post/${post._id}"
                          style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #ef4444; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 1px solid #ef4444; border-right: 1px solid #ef4444; border-bottom: 1px solid #ef4444; border-left: 1px solid #ef4444; padding-top: 5px; padding-bottom: 5px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
                          target="_blank"><span
                            style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:undefined;"><span
                              style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">View Pending
                              Post</span></span></a>
                      </div>
                    </div>
                  </div>
