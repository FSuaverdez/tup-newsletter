...
import { useDeletePendingPostMutation } from '../../../../app/services/postApi';
import Button from '../../../../components/Button/Button';

const DeletePendingPostModal = ({handleCloseModal,postId,classes,post}) => {
    let categoryId
    const [deletePost] = useDeletePendingPostMutation();
...
export default DeletePendingPostModal;