...
import { useGetAllArchivedPostsQuery } from '../../app/services/postApi';
  ...
  return (
    <div className='p-5 max-w-5xl mx-auto article-container'>
      <div className='bg-white p-5 rounded-lg shadow-lg mx-auto mb-5'>
        <h1 className='text-2xl font-bold mb-10'>Archived Posts</h1>
        ...
        {isLoading || isFetching ? (
          ...
          posts?.map(post => {
              return (
                <Link to={`/archived/post/${post._id}`} key={post._id}>
